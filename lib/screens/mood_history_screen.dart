...
class _MoodHistoryScreenState extends State<MoodHistoryScreen> {
            ...
            onPressed: () async {
              ...
              if (mounted) {
                scaffoldMessenger.showSnackBar(
                  SnackBar(
                    content: const Text('Added test moods'),
                  ...
                  child: Wrap(
                    ...
                    children: filters.map((filter) => ChoiceChip(
                      label: Text(
                        filter,
                        style: TextStyle(
                          color: selectedFilter == filter ? creamWhite : darkChocolate,
                        ),
                      ),
                      selected: selectedFilter == filter,
                      selectedColor: mediumChocolate,
                      backgroundColor: creamWhite,
                      side: BorderSide(color: mediumChocolate.withOpacity(0.3)),
                      onSelected: (selected) {
                        if (selected) {
                          setState(() {
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(
                            color: darkChocolate.withOpacity(0.1),
                            blurRadius: 10,
                            offset: const Offset(0, 4),
                          ),
                        ],
                        border: Border.all(color: mediumChocolate.withOpacity(0.2)),
                      ),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    border: Border.all(color: mediumChocolate.withOpacity(0.3)),
                                  ),
                                  child: Text(
                                    '${entry.value}',
                                    style: TextStyle(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: theme.textTheme.bodyMedium?.copyWith(
                              color: lightChocolate.withOpacity(0.7),
                            ),
                      ...
                      return Padding(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(color: mediumChocolate.withOpacity(0.1)),
                          ),
                          child: ListTile(
  ...
  Widget _buildStatCard(String title, String value, IconData icon) {
    return Container(
      ...
      child: Column(
        children: [
          Icon(icon, color: mediumChocolate, size: 24),
          const SizedBox(height: 8),
          Text(
            value,
            style: TextStyle(
