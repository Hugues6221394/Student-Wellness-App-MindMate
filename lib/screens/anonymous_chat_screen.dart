...
class _AnonymousChatScreenState extends State<AnonymousChatScreen> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: const Color(0xFF3A1F04), // Dark chocolate
          ...
          Wrap(
            ...
            children: _predefinedTopics.map((topic) {
              return ActionChip(
                ...
                backgroundColor: const Color(0xFFD2B48C), // Tan color
        ...
        children: [
          ...
          Flexible(
            child: Container(
              ...
              decoration: BoxDecoration(
                color: isMyMessage ? const Color(0xFF3A1F04) : Colors.white,
                borderRadius: BorderRadius.circular(20),
                boxShadow: [
                  BoxShadow(
                    color: Colors.brown.withOpacity(0.06),
